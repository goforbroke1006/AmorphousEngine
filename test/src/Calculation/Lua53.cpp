...
TEST(TestLua53_buildInitLuaCode, _01_scene_with_gObjects_and_cmp) {
    ...
    std::string expected
            = "require 'Core'\n"
              ...
              "end\n"
              "\n"
              "allComponents['go 0 :: Main Camera :: Camera'] = Camera:new()\n"
              "allComponents['go 0 :: Main Camera :: Camera'].__name = 'Camera'\n"
              "allComponents['go 0 :: Main Camera :: Camera'].gameObject = allGameObjects['go 0 :: Main Camera']\n"
              "allComponents['go 0 :: Main Camera :: Camera'].transform = allGameObjects['go 0 :: Main Camera'].transform\n"
              "\n"
              "allComponents['go 0 :: Main Camera :: Camera'].backgroundColor = Color:new(0.250000, 0.750000, 0.250000, 1.000000)\n"
              "allComponents['go 0 :: Main Camera :: Camera'].enabled = true\n"
              "allComponents['go 0 :: Main Camera :: Camera'].farClipPlane = 1000.000000\n"
              "allComponents['go 0 :: Main Camera :: Camera'].nearClipPlane = 0.100000\n"
              "\n"
              "allComponents['go 1 :: Player :: CharacterController'] = CharacterController:new()\n"
              "allComponents['go 1 :: Player :: CharacterController'].__name = 'CharacterController'\n"
              "allComponents['go 1 :: Player :: CharacterController'].gameObject = allGameObjects['go 1 :: Player']\n"
              "allComponents['go 1 :: Player :: CharacterController'].transform = allGameObjects['go 1 :: Player'].transform\n"
              "\n"
              "allComponents['go 1 :: Player :: CharacterController'].camera = allGameObjects['go 0 :: Main Camera'].transform\n"
              "allComponents['go 1 :: Player :: CharacterController'].enabled = true\n"
              "allComponents['go 1 :: Player :: CharacterController'].runningSpeed = 2.000000\n"
              "\n"
              "for _, cmpInstance in pairs(allComponents) do\n"
              "    cmpInstance:Start()\n"
              "end\n";
